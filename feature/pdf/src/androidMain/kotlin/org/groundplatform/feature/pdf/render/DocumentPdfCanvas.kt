...
/**
 * [PdfCanvas] that draws onto a real [android.graphics.pdf.PdfDocument], one page at a time. Image bitmaps are expected
...
internal class DocumentPdfCanvas(private val pdf: PdfDocument) : PdfCanvas {
  ...
  override fun startPage(pageNumber: Int) {
    val info = PdfDocument.PageInfo.Builder(PdfConfig.PAGE_WIDTH, PdfConfig.PAGE_HEIGHT, pageNumber).create()
