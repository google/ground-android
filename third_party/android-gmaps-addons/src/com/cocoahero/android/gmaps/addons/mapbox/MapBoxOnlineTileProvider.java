...
public class MapBoxOnlineTileProvider extends UrlTileProvider {
  ...
  static { FORMAT = "%s://api.tiles.mapbox.com/v3/%s/%d/%d/%d.png"; }
   ...
   */
  public String getMapIdentifier() { return this.mMapIdentifier; }
   ...
   */
  public boolean isHttpsEnabled() { return this.mHttpsEnabled; }
   ...
   * @param enabled
   */
  public void setHttpsEnabled(boolean enabled) { this.mHttpsEnabled = enabled; }
  ...
  public URL getTileUrl(int x, int y, int z) {
    try {
      ...
      return new URL(
          String.format(FORMAT, protocol, this.mMapIdentifier, z, x, y));
