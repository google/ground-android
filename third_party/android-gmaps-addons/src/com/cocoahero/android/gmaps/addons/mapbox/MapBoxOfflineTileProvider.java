...
public class MapBoxOfflineTileProvider implements TileProvider, Closeable {
  ...
  public MapBoxOfflineTileProvider(File file) { this(file.getAbsolutePath()); }
  ...
  public Tile getTile(int x, int y, int z) {
    ...
    if (this.isZoomLevelAvailable(z) && this.isDatabaseAvailable()) {
      ...
      String[] values = {String.valueOf(row), String.valueOf(x),
                         String.valueOf(z)};
      Cursor c = this.mDatabase.query("tiles", projection, predicate, values,
                                      null, null, null);
      if (c != null) {
        c.moveToFirst();
        if (!c.isAfterLast()) {
   ...
   */
  public int getMinimumZoom() { return this.mMinimumZoom; }
   ...
   *         it could not be determined.
   */
  public int getMaximumZoom() { return this.mMaximumZoom; }
   ...
   *         be determined.
   */
  public LatLngBounds getBounds() { return this.mBounds; }
  ...
  private void calculateZoomConstraints() {
    if (this.isDatabaseAvailable()) {
      ...
      c = this.mDatabase.query("metadata", projection, "name = ?", minArgs,
                               null, null, null);
      ...
      c = this.mDatabase.query("metadata", projection, "name = ?", maxArgs,
                               null, null, null);
