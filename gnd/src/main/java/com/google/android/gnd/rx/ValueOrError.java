...
public class ValueOrError<T> {
  ...
  @NonNull
  public static <T> ValueOrError<T> create(@NonNull Supplier<T> supplier) {
    try {
  ...
  @NonNull
  public static <T> Observable<T> ignoreErrors(@NonNull Observable<ValueOrError<T>> observable) {
