...
public class ProjectConverter {
  ...
  public static Project toProject(DocumentSnapshot doc) throws DataStoreException {
    ...
    if (pd.getFeatureTypes() != null) {
      Maps.forEach(pd.getFeatureTypes(), (id, ptDoc) -> project.putLayer(id, ptDoc.toObject(id)));
    }
