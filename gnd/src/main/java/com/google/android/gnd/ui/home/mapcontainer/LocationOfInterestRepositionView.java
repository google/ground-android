...
import com.google.android.gnd.databinding.MapMoveLocationOfInterestLayoutBinding;
...
@AndroidEntryPoint
public class LocationOfInterestRepositionView extends AbstractView {

  public LocationOfInterestRepositionView(Context context, MapFragment mapFragment) {
    super(context);
    LocationOfInterestRepositionViewModel viewModel =
        getViewModel(LocationOfInterestRepositionViewModel.class);
    MapMoveLocationOfInterestLayoutBinding binding =
        (MapMoveLocationOfInterestLayoutBinding)
