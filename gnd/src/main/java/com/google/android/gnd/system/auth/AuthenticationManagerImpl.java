...
public class AuthenticationManagerImpl implements AuthenticationManager {
  ...
  private static final int SIGN_IN_REQUEST_CODE = AuthenticationManagerImpl.class.hashCode() & 0xffff;
  ...
  @Inject
  public AuthenticationManagerImpl(Application application, ActivityStreams activityStreams) {
