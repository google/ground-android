...
public class GoogleAuthenticationManager implements AuthenticationManager {
  private static final String TAG = GoogleAuthenticationManager.class.getSimpleName();
  private static final int SIGN_IN_REQUEST_CODE = GoogleAuthenticationManager.class.hashCode() & 0xffff;
