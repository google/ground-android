...
interface SurveyRepositoryInterface {
  ...
  /** Records where a [mode] sync of [survey] left off, for the next one to resume from. */
  suspend fun recordSyncState(survey: Survey, mode: SurveySyncMode, latestLoiServerTimestamp: Long)
