...
private fun manropeFontFamily() =
  FontFamily(
    Font(resource = Res.font.manrope_medium, weight = FontWeight.Medium, style = FontStyle.Normal),
    Font(resource = Res.font.manrope_bold, weight = FontWeight.Bold, style = FontStyle.Normal),
  )

@Composable
private fun urbanistFontFamily() =
  FontFamily(
    Font(resource = Res.font.urbanist_medium, weight = FontWeight.Medium, style = FontStyle.Normal),
    Font(resource = Res.font.urbanist_bold, weight = FontWeight.Bold, style = FontStyle.Normal),
  )
