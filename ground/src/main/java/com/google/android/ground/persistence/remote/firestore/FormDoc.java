...
import com.google.android.ground.model.form.Field.Type;
...
public class FormDoc {
  ...
  public static class Element {
    ...
    static com.google.android.ground.model.form.Element toObject(Element em) {
      return toField(em)
          .map(com.google.android.ground.model.form.Element::ofField)
          .orElse(com.google.android.ground.model.form.Element.ofUnknown());
    }
    ...
    public static class Option {
      ...
      public static com.google.android.ground.model.form.Option toOption(Option option) {
        com.google.android.ground.model.form.Option.Builder builder =
            com.google.android.ground.model.form.Option.newBuilder();
        if (option.code != null) {
