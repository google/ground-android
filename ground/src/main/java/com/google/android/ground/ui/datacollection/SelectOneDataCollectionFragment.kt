...
import com.google.android.ground.databinding.SelectOneDataCollectionFragBinding
 ...
 */
@AndroidEntryPoint
class SelectOneDataCollectionFragment
constructor(private val task: Task, private val viewModel: AbstractTaskViewModel) :
  ...
  override fun onCreateView(
    ...
    val binding = SelectOneDataCollectionFragBinding.inflate(inflater, container, false)

    binding.lifecycleOwner = this
    binding.setVariable(BR.viewModel, viewModel)

    val optionAdapter = SelectOneOptionAdapter(task.multipleChoice!!.options)
