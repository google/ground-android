...
data class PointOfInterest(
    ...
    override fun toMutation(type: Mutation.Type, userId: String): LocationOfInterestMutation {
        return super.toMutation(type, userId).toBuilder().setLocation(
            Optional.of(
                point
            )
        ).build()
    ...
    class Builder : LocationOfInterest.Builder() {
        ...
        override fun setCaption(value: String?): Builder =
            apply { super.setCaption(value) }

        override fun setCreated(value: AuditInfo): Builder =
            apply { super.setCreated(value) }

        override fun setCustomId(value: String?): Builder =
            apply { super.setCustomId(value) }

        override fun setJob(value: Job): Builder = apply { super.setJob(value) }
        override fun setSurvey(value: Survey): Builder =
            apply { super.setSurvey(value) }

        override fun setLastModified(value: AuditInfo): Builder =
            apply { super.setLastModified(value) }

        fun setPoint(value: Point): Builder = apply { this.point = value }
        fun build(): PointOfInterest {
            ...
            val point = point ?: throw Exception("Expected a point")

            return PointOfInterest(id, survey, job, customId, caption, created, lastModified, point)
        }
    }

    override fun toBuilder(): Builder =
        Builder().setPoint(point).setCaption(caption).setJob(job).setCreated(created).setId(id)
