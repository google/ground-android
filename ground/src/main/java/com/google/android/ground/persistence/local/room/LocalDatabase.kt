 ...
 *
 *
 * A separate data model is used to represent data stored locally to prevent leaking db-level
 * design details into main API * and to allow us to guarantee backwards compatibility.
 */
@Database(
    entities = [LocationOfInterestEntity::class, LocationOfInterestMutationEntity::class, TaskEntity::class, JobEntity::class, MultipleChoiceEntity::class, OptionEntity::class, SurveyEntity::class, BaseMapEntity::class, SubmissionEntity::class, SubmissionMutationEntity::class, TileSetEntity::class, OfflineAreaEntity::class, UserEntity::class],
