...
import org.groundplatform.android.data.local.room.RoomLocalDatabase
...
abstract class LocalDataStoreModule {
  ...
  @Binds
  @Singleton
  abstract fun localDatabase(
    database: RoomLocalDatabase
  ): org.groundplatform.data.stores.LocalDatabase
