...
import org.groundplatform.android.data.local.room.entity.AuditInfoEntity
...
import org.groundplatform.android.data.local.room.entity.StyleEntity
...
import org.groundplatform.android.data.local.room.relations.ConditionEntityAndRelations
  ...
  return Job(
    ...
    strategy =
      jobEntity.strategy.let {
        try {
          Job.DataCollectionStrategy.valueOf(it)
