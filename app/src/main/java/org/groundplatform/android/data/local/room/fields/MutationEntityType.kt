...
enum class MutationEntityType(private val intValue: Int) : IntEnum {
  ...
  companion object {
    ...
    fun toInt(value: MutationEntityType?) =
      toInt(value, org.groundplatform.android.data.local.room.fields.MutationEntityType.UNKNOWN)
    ...
    fun fromInt(intValue: Int) =
      fromInt(
        ...
        intValue,
        org.groundplatform.android.data.local.room.fields.MutationEntityType.UNKNOWN,
      )
  }
}
