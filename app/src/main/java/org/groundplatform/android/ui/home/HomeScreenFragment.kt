  ...
  override fun onCreateView(
    ...
    composeView.setContent {
      org.groundplatform.android.ui.theme.AppTheme {
        ...
        val user by androidx.compose.runtime.produceState<User?>(initialValue = null) {
          value = userRepository.getAuthenticatedUser()
        }
        val survey by homeScreenViewModel.surveyRepository.activeSurveyFlow.collectAsStateWithLifecycle(null)
        ...
        HomeScreen(
          ...
          drawerContent = {
             ...
             HomeDrawer(
               ...
               survey = survey,
               onSwitchSurvey = {
                  findNavController().navigate(HomeScreenFragmentDirections.actionHomeScreenFragmentToSurveySelectorFragment(false))
                  scope.launch { drawerState.close() }
               },
               ...
               onNavigateToSettings = {
                   findNavController().navigate(HomeScreenFragmentDirections.actionHomeScreenFragmentToSettingsActivity())
                   scope.launch { drawerState.close() }
               },
               onNavigateToAbout = {
            ...
            androidx.compose.ui.viewinterop.AndroidView(
                factory = { context ->
                    android.widget.FrameLayout(context).apply {
                        id = R.id.map_container_fragment
                    }
                },
                update = { view ->
                    val fragment = childFragmentManager.findFragmentById(R.id.map_container_fragment)
                    if (fragment == null) {
                        val mapFragment = org.groundplatform.android.ui.home.mapcontainer.HomeScreenMapContainerFragment()
               ...
               // ... draft restored logic ...
                   homeScreenViewModel.getDraftSubmission()?.let { draft ->
                       ...
                       if (!homeScreenViewModel.awaitingPhotoCapture) {
                           ephemeralPopups.InfoPopup(view, R.string.draft_restored, EphemeralPopups.PopupDuration.SHORT).show()
                       } else {
